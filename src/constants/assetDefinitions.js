...
export const INDIAN_STOCKS = [
  ...
  { id: 'M&M', name: 'Mahindra & Mahindra', csvFile: 'MandM.csv', sector: 'Auto', category: 'Indian_Stocks' },
  ...
  // CRITICAL FIXES - Sanitized filenames for production compatibility
  { id: 'Weizmann', name: 'Weizmann', csvFile: 'Weizmann.csv', sector: 'Diversified', category: 'Indian_Stocks' },
  { id: 'Indo National', name: 'Indo National', csvFile: 'Indo_National.csv', sector: 'Diversified', category: 'Indian_Stocks' },
  { id: 'HFCL', name: 'HFCL Limited', csvFile: 'HFCL.csv', sector: 'Telecom', category: 'Indian_Stocks' },
  { id: 'Zee Entertainment', name: 'Zee Entertainment', csvFile: 'Zee_Entertainment.csv', sector: 'Media', category: 'Indian_Stocks' },
  { id: 'Ashok Leyland', name: 'Ashok Leyland', csvFile: 'Ashok_Leyland.csv', sector: 'Auto', category: 'Indian_Stocks' },
  { id: 'ITI Limited', name: 'ITI Limited', csvFile: 'ITI_Limited.csv', sector: 'Telecom', category: 'Indian_Stocks' },
  { id: 'CESC Limited', name: 'CESC Limited', csvFile: 'CESC_Limited.csv', sector: 'Power', category: 'Indian_Stocks' },
  ...
  { id: 'Jindal Stainless', name: 'Jindal Stainless', csvFile: 'Jindal_Stainless.csv', sector: 'Metals', category: 'Indian_Stocks' },
  { id: 'UCO Bank', name: 'UCO Bank', csvFile: 'UCO_Bank.csv', sector: 'Banking', category: 'Indian_Stocks' },
  { id: 'NTPC', name: 'NTPC Limited', csvFile: 'NTPC.csv', sector: 'Power', category: 'Indian_Stocks' },
  { id: 'Indiabulls Real Estate', name: 'Indiabulls Real Estate', csvFile: 'Indiabulls_Real_Estate.csv', sector: 'Real Estate', category: 'Indian_Stocks' },
  { id: 'Suzlon Energy', name: 'Suzlon Energy', csvFile: 'Suzlon_Energy.csv', sector: 'Power', category: 'Indian_Stocks' },
  { id: 'JP Power Ventures', name: 'JP Power Ventures', csvFile: 'JP_Power_Ventures.csv', sector: 'Power', category: 'Indian_Stocks' },
  { id: 'Yes Bank', name: 'Yes Bank', csvFile: 'Yes_Bank.csv', sector: 'Banking', category: 'Indian_Stocks' },
  ...
  { id: 'GVK Power & Infra', name: 'GVK Power & Infra', csvFile: 'GVK_Power_and_Infra.csv', sector: 'Infrastructure', category: 'Indian_Stocks' },
  ...
  { id: 'Vodafone Idea', name: 'Vodafone Idea', csvFile: 'Vodafone_Idea.csv', sector: 'Telecom', category: 'Indian_Stocks' },
  { id: 'Websol Energy Systems', name: 'Websol Energy Systems', csvFile: 'Websol_Energy_Systems.csv', sector: 'Energy', category: 'Indian_Stocks' },
  { id: 'Dish TV India', name: 'Dish TV India', csvFile: 'Dish_TV_India.csv', sector: 'Media', category: 'Indian_Stocks' },
  { id: 'Reliance Power', name: 'Reliance Power', csvFile: 'Reliance_Power.csv', sector: 'Power', category: 'Indian_Stocks' },
  { id: 'IRB Infrastructure', name: 'IRB Infrastructure', csvFile: 'IRB_Infrastructure.csv', sector: 'Infrastructure', category: 'Indian_Stocks' },
  { id: 'RattanIndia Power', name: 'RattanIndia Power', csvFile: 'RattanIndia_Power.csv', sector: 'Power', category: 'Indian_Stocks' },
  { id: 'Adani Power', name: 'Adani Power', csvFile: 'Adani_Power.csv', sector: 'Power', category: 'Indian_Stocks' },
  { id: 'Hindustan Copper', name: 'Hindustan Copper', csvFile: 'Hindustan_Copper.csv', sector: 'Metals', category: 'Indian_Stocks' },
  { id: 'Manappuram Finance', name: 'Manappuram Finance', csvFile: 'Manappuram_Finance.csv', sector: 'Finance', category: 'Indian_Stocks' },
  { id: 'RattanIndia Enterprises', name: 'RattanIndia Enterprises', csvFile: 'RattanIndia_Enterprises.csv', sector: 'Diversified', category: 'Indian_Stocks' },
  { id: 'Spacenet Enterprises', name: 'Spacenet Enterprises', csvFile: 'Spacenet_Enterprises.csv', sector: 'Technology', category: 'Indian_Stocks' },
  { id: 'INDIGO', name: 'InterGlobe Aviation (IndiGo)', csvFile: 'INDIGO.csv', sector: 'Aviation', category: 'Indian_Stocks' },
  { id: 'Brightcom Group', name: 'Brightcom Group', csvFile: 'Brightcom_Group.csv', sector: 'Technology', category: 'Indian_Stocks' },
  { id: 'Quick Heal Technologies', name: 'Quick Heal Technologies', csvFile: 'Quick_Heal_Technologies.csv', sector: 'IT', category: 'Indian_Stocks' },
  { id: 'PNB Housing Finance', name: 'PNB Housing Finance', csvFile: 'PNB_Housing_Finance.csv', sector: 'Finance', category: 'Indian_Stocks' },
  { id: 'SBILIFE', name: 'SBI Life Insurance', csvFile: 'SBILIFE.csv', sector: 'Insurance', category: 'Indian_Stocks' },
  { id: 'Sanginita Chemicals', name: 'Sanginita Chemicals', csvFile: 'Sanginita_Chemicals.csv', sector: 'Chemicals', category: 'Indian_Stocks' },
  { id: 'Vertoz', name: 'Vertoz', csvFile: 'Vertoz.csv', sector: 'Technology', category: 'Indian_Stocks' },
  { id: '5Paisa Capital', name: '5Paisa Capital', csvFile: '5Paisa_Capital.csv', sector: 'Finance', category: 'Indian_Stocks' },
  { id: 'NACL Industries', name: 'NACL Industries', csvFile: 'NACL_Industries.csv', sector: 'Chemicals', category: 'Indian_Stocks' },
  { id: 'Indostar Capital Finance', name: 'Indostar Capital Finance', csvFile: 'Indostar_Capital_Finance.csv', sector: 'Finance', category: 'Indian_Stocks' },
  { id: 'Vinny Overseas', name: 'Vinny Overseas', csvFile: 'Vinny_Overseas.csv', sector: 'Diversified', category: 'Indian_Stocks' },
  { id: 'Ujjivan Small Finance Bank', name: 'Ujjivan Small Finance Bank', csvFile: 'Ujjivan_Small_Finance_Bank.csv', sector: 'Banking', category: 'Indian_Stocks' },
  { id: 'Ksolves India', name: 'Ksolves India', csvFile: 'Ksolves_India.csv', sector: 'IT', category: 'Indian_Stocks' },
  { id: 'MTAR Technologies', name: 'MTAR Technologies', csvFile: 'MTAR_Technologies.csv', sector: 'Engineering', category: 'Indian_Stocks' },
  { id: 'One97 Communications (Paytm)', name: 'One97 Communications (Paytm)', csvFile: 'One97_Communications_Paytm.csv', sector: 'Fintech', category: 'Indian_Stocks' },
  { id: 'Easy Trip Planners', name: 'Easy Trip Planners', csvFile: 'Easy_Trip_Planners.csv', sector: 'Travel', category: 'Indian_Stocks' },
  { id: 'Railtel Corporation', name: 'Railtel Corporation', csvFile: 'Railtel_Corporation.csv', sector: 'Telecom', category: 'Indian_Stocks' },
  { id: 'Honasa Consumer', name: 'Honasa Consumer', csvFile: 'Honasa_Consumer.csv', sector: 'Consumer', category: 'Indian_Stocks' },
  { id: 'Hindustan Construction', name: 'Hindustan Construction', csvFile: 'Hindustan_Construction.csv', sector: 'Infrastructure', category: 'Indian_Stocks' },
];
